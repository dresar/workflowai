...
const technologiesData = [
  ...
  { name: 'Nuxt', category: 'Frontend', version: '3.13', description: 'Intuitive Vue Framework', sortOrder: 7 },
  ...
  { name: 'FastAPI', category: 'Backend', version: '0.115', description: 'Modern, fast Python web framework', sortOrder: 14 },
  { name: 'Laravel', category: 'Backend', version: '11.0', description: 'PHP web framework', sortOrder: 15 },
  { name: 'Go (Fiber)', category: 'Backend', version: '2.0', description: 'Go web framework', sortOrder: 16 },
  { name: 'Spring Boot', category: 'Backend', version: '3.3', description: 'Java-based application framework', sortOrder: 17 },
  { name: 'GraphQL', category: 'Backend', version: '-', description: 'Data query and manipulation language', sortOrder: 18 },
  { name: 'gRPC', category: 'Backend', version: '-', description: 'High performance RPC framework', sortOrder: 19 },
  ...
  { name: 'Supabase', category: 'Database', version: '-', description: 'Open source Firebase alternative', sortOrder: 25 },
  { name: 'Neon', category: 'Database', version: '-', description: 'Serverless Postgres', sortOrder: 26 },
  ...
  { name: 'GCP', category: 'Deployment', version: '-', description: 'Google Cloud Platform', sortOrder: 34 },
  { name: 'Docker', category: 'Deployment', version: '27.0', description: 'Container platform', sortOrder: 35 },
  { name: 'Kubernetes', category: 'Deployment', version: '1.31', description: 'Container orchestration', sortOrder: 36 },
  { name: 'Terraform', category: 'Deployment', version: '1.9', description: 'Infrastructure as Code', sortOrder: 37 },
  ...
  { name: 'NextAuth / Auth.js', category: 'Authentication', version: '5.0', description: 'Authentication for Web', sortOrder: 43 },
  { name: 'JWT', category: 'Authentication', version: '-', description: 'JSON Web Token based auth', sortOrder: 44 },
  ...
  { name: 'Framer Motion', category: 'Styling', version: '11.0', description: 'Animation library for React', sortOrder: 54 },
  ...
  { name: 'MobX', category: 'State Management', version: '6.0', description: 'Simple, scalable state management', sortOrder: 63 },
  ...
  { name: 'Jest', category: 'Testing', version: '29.0', description: 'Delightful JavaScript Testing', sortOrder: 92 },
  { name: 'Cypress', category: 'Testing', version: '13.0', description: 'Fast, easy and reliable testing', sortOrder: 93 },
  
  // AI & ORM & Message Brokers
  { name: 'LangChain', category: 'AI Framework', version: '0.3', description: 'LLM application framework', sortOrder: 100 },
  { name: 'LlamaIndex', category: 'AI Framework', version: '0.12', description: 'Data framework for LLMs', sortOrder: 101 },
  ...
  { name: 'RabbitMQ', category: 'Message Broker', version: '3.13', description: 'Open source message broker', sortOrder: 120 },
  { name: 'Apache Kafka', category: 'Message Broker', version: '3.8', description: 'Distributed event streaming', sortOrder: 121 },
];
